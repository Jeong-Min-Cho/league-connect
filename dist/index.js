...
async function authenticate(options) {
  async function tryAuthenticate() {
    ...
    const portRegex = (options == null ? void 0 : options.IsRiotClient) ? /--riotclient-app-port=([0-9]+)/ : /--app-port=([0-9]+)/;
    const passwordRegex = (options == null ? void 0 : options.IsRiotClient) ? /--riotclient-auth-token=([\w-_]+)/ : /--remoting-auth-token=([\w-_]+)/;
